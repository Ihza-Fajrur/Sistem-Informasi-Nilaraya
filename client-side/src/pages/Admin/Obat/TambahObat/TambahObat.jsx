      ...
      <div className="head">
        <div className="wrap-bagianAtas">
          <div className="bagianAtas">
            <h1>Form Penambahan Data Obat</h1>
          </div>
        </div>
        ...
        <div className="wrap-table">
          <form action="">
            <div className="wrap-input">
              <label htmlFor="namaobat" className="label-input">
                Nama Obat
              </label>
              <input
                type="text"
            ...
            <div className="wrap-input">
              <label htmlFor="kuantitas" className="label-input">
                Kuantitas
              </label>
              <input
                type="text"
            ...
            <div className="flex-input">
              <div className="wrap-input">
                <label htmlFor="hargajual" className="label-input">
                  Harga Jual/Strip
                </label>
                <input
                  type="number"
                  className="input-field"
                  placeholder="Masukkan Harga Jual/Strip"
                />
              </div>
              <div className="wrap-input">
                <label htmlFor="hargajualsatuan" className="label-input">
                  Harga Jual Satuan
                </label>
                <input
                  type="number"
                  className="input-field"
                  placeholder="Masukkan Harga Jual Satuan"
                />
              </div>
            </div>
            <div className="wrap-input">
              <label htmlFor="hargabeli" className="label-input">
                Harga Beli
              </label>
              <input
                type="number"
            ...
            <div className="wrap-input">
              <label htmlFor="expdate" className="label-input">
                Exp Date
              </label>
              <input
                type="date"
            ...
            <div className="wrap-input">
              <label htmlFor="jenis" className="label-input">
                Jenis Obat
              </label>
